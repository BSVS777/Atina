-- Extraído de sistema_gestion_academica_utn.sql (schema compartido del profesor, secciones 3-8).
-- No editar a mano sin actualizar también Docs/sistema_gestion_academica_utn.sql.
